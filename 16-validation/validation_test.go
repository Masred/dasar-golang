...
func MustValidateRegisterSuccess(level validator.StructLevel) {
...
func TestStructLevelValidation(t *testing.T) {
	validate := validator.New()
	validate.RegisterStructValidation(MustValidateRegisterSuccess, RegisterRequest{})
